...
<%@ attribute name="document" required="true" rtexprvalue="true" type="com.lianhua.document.model.Document" %>
						<script type="text/javascript">
							$(function() {
								...
								checksumer.checksum([
									{id:"prop_prop2",text:"累计折旧"}, 
									{id:"prop_prop3",text:"本年折旧"}
									]
								);
								checksumer.checksum([
									{id:"prop_prop6",text:"实收资本（股本）"}, 
									{id:"prop_prop7",text:"国家资本"},
									{id:"prop_prop8",text:"集体资本"},
									{id:"prop_prop9",text:"法人资本"},
									{id:"prop_prop10",text:"个人资本"},
									{id:"prop_prop11",text:"港澳台商资本"},
									{id:"prop_prop12",text:"外商资本"}
									], {relation:"="}
								);
								checksumer.checksum([
									{id:"prop_prop13",text:"主营业务收入"}, 
									{id:"prop_prop14",text:"体育及相关业务收入"}
									]
								);
							});
						</script>
                            ...
                            <td style="padding-left:inherit;" colspan="2">
                                <table>
                                    ...
                                    <tbody class="thL">
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;固定资产原价<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop1') }"></th>
                                            <td>01</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	累计折旧<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop2') }"></th>
                                            <td>02</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	其中：本年折旧<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop3') }"></th>
                                            <td>03</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	资产总计<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop4') }"></th>
                                            <td>04</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	负债合计<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop5') }"></th>
                                            <td>05</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	实收资本（股本）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop6') }"></th>
                                            <td>06</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	1.国家资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop7') }"></th>
                                            <td>07</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	2.集体资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop8') }"></th>
                                            <td>08</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	3.法人资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop9') }"></th>
                                            <td>09</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	4.个人资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop10') }"></th>
                                            <td>10</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	5.港澳台商资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop11') }"></th>
                                            <td>11</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	6.外商资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop12') }"></th>
                                            <td>12</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	主营业务收入<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop13') }"></th>
                                            <td>13</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                            	其中：体育及相关业务收入<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop14') }"></th>
                                            <td>14</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	主营业务成本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop15') }"></th>
                                            <td>15</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	主营业务税金及附加<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop16') }"></th>
                                            <td>16</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;  
                                            	营业费用<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop17') }"></th>
                                            <td>17</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	管理费用<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop18') }"></th>
                                            <td>18</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	财务费用<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop19') }"></th>
                                            <td>19</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	营业利润（亏损以“-”号填列）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop20') }"></th>
                                            <td>20</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	利润总额（亏损以“-”号填列）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop21') }"></th>
                                            <td>21</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	从业人员劳动报酬<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop22') }"></th>
                                            <td>22</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	劳动、失业保险费<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop23') }"></th>
                                            <td>23</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	本年应交增值税<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop24') }"></th>
                                            <td>24</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	工业总产值（当年价）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop25') }"></th>
                                            <td>25</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	工业销售产值（当年价）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop26') }"></th>
                                            <td>26</td>
