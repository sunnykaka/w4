...
<%@ attribute name="document" required="true" rtexprvalue="true" type="com.lianhua.document.model.Document" %>
						<script type="text/javascript">
							$(function() {
								...
								checksumer.checksum([
									{id:"prop_industrialOutputValue",text:"工业总产值（当年价格）"}, 
									{id:"prop_sportsOutputValue",text:"体育用品、体育服装鞋帽、体育相关产品产值"}
									]
								);
								checksumer.checksum([
									{id:"prop_employeeNum",text:"平均从业人员数"}, 
									{id:"prop_sportsEmployeeNum",text:"体育用品、体育服装鞋帽、体育相关产品制造的从业人员数"}
									]
								);
							});
						</script>
				        ...
				        <tr>
							<th>所属行业：<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'industryCode') }" /></th>
							<td colspan="4">
								<w4tag:code kind="t111_option" name="prop_industryCode" value="${w4:showValue(document, 'industryCode')}" type="checkbox" required="true"/>
							</td>
						</tr>
						<tr>
                            <td style="padding:inherit;" colspan="2">
                                <table>
                                    ...
                                    <tbody class="thL">
                                        ...
                                        <tr>
                                            <th>工业总产值（当年价格）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'industrialOutputValue') }" /></th>
                                            <td>万元</td>
                                            <td><input type="text" name="prop_industrialOutputValue" id="prop_industrialOutputValue" value="${w4:showNumber(document, 'industrialOutputValue')}" data-validation-engine="validate[required,custom[number]]" money="true"/></td>
                                        </tr>
										  <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;其中：体育用品、体育服装鞋帽、体育相关产品产值<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'sportsOutputValue') }" /></th>
                                            <td>万元</td>
                                            <td><input type="text" name="prop_sportsOutputValue" id="prop_sportsOutputValue" value="${w4:showNumber(document, 'sportsOutputValue')}" data-validation-engine="validate[required,custom[number]]" money="true"/></td>
                                        </tr>
										<tr>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 其中：体育用品、体育服装鞋帽、体育相关产品制造的从业人员数<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'sportsEmployeeNum') }" /></th>
											<td>人</td>
