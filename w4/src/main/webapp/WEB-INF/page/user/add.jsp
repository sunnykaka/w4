		...
		<tbody>
			...
			<tr>
				...
				<td colspan="3">
					...
					<!-- 
						<option value="0" <c:if test="${empty user.type or user.type eq 0}">selected="selected"</c:if>>企业用户</option>
					 -->
						<option value="1" <c:if test="${empty user.type or user.type eq 1}">selected="selected"</c:if>>区管理员</option>
