...
<%@ attribute name="document" required="true" rtexprvalue="true" type="com.lianhua.document.model.Document" %>
						<script type="text/javascript">
							$(function() {
								...
								checksumer.checksum([
									...
									{id:"prop_sportsRevenue",text:"体育用品销售收入"},
									{id:"prop_clothesRevenue",text:"体育服装销售收入"},
									{id:"prop_catsRevenue",text:"体育鞋帽销售收入"}
									]
								);
								checksumer.checksum([
									{id:"prop_employeeNum",text:"平均从业人员数"}, 
									{id:"prop_sportsEmployeeNum",text:"从事体育用品、体育服装鞋帽销售从业人员数"}
									]
								);
							});
						</script>
				        ...
				        <tr>
							<th>业态：</th>
							<td colspan="4">
								<w4tag:code kind="t109_option" name="prop_businessTypeCode" value="${w4:showValue(document, 'businessTypeCode')}" type="radio" required="true" />
							</td>
						</tr>
						<tr>
                                ...
                                <table>
                                    ...
                                    <tbody class="thL">
                                        ...
                                        <tr>
										  ...
										  <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;其中：体育用品销售收入<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'sportsRevenue') }" /></th>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 体育服装销售收入<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'clothesRevenue') }" /></th>
											<td>万元</td>
                                            <td><input type="text" name="prop_clothesRevenue" id="prop_clothesRevenue" value="${w4:showNumber(document, 'clothesRevenue')}" data-validation-engine="validate[required,custom[number]]" money="true"/></td>
                                        </tr>
										<tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 体育鞋帽销售收入<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'catsRevenue') }" /></th>
											<td>万元</td>
                                            <td><input type="text" name="prop_catsRevenue" id="prop_catsRevenue" value="${w4:showNumber(document, 'catsRevenue')}" data-validation-engine="validate[required,custom[number]]" money="true"/></td>
                                        </tr>
										<tr>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 其中：从事体育用品、体育服装鞋帽销售从业人员数<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'sportsEmployeeNum') }" /></th>
											<td>人</td>
