						...
						<script type="text/javascript">
							$(function() {
								...
								checksumer.checksum([
									...
									{id:"prop_prop3",text:"体育设备类投资金额"}
									]
								);
								checksumer.checksum([
									{id:"prop_prop4",text:"累计折旧"}, 
									{id:"prop_prop5",text:"本年折旧"}
									]
								);
								checksumer.checksum([
								...
								checksumer.checksum([
									{id:"prop_prop17",text:"主营业务成本"}, 
									{id:"prop_prop18",text:"体育及相关业务成本"}
									]
								);
							});
						</script>
                            ...
                            <td style="padding:inherit;" colspan="2">
                                <table>
                                    ...
                                    <tbody class="thL">
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其中：体育设备类投资<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop3') }"></th>
                                            <td>03</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;3.累计折旧<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop4') }"></th>
                                            <td>04</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;其中：本年折旧<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop5') }"></th>
                                            <td>05</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;4.负债合计<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop6') }"></th>
                                            <td>06</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;5.实收资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop7') }"></th>
                                            <td>07</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;其中：国家资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop8') }"></th>
                                            <td>08</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
                                            	外商资本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop13') }"></td>
                                            <td>13</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp;
                                            	6.营业收入合计<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop14') }"></th>
                                            <td>14</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	7.主营业务成本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop17') }"></th>
                                            <td>17</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
                                            	其中：体育及相关业务成本<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop18') }"></th>
                                            <td>18</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	8.主营业务税金及附加<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop19') }"></th>
                                            <td>19</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	9.营业费用<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop20') }"></th>
                                            <td>20</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	10.管理费用<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop21') }"></th>
                                            <td>21</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	11.财务费用<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop22') }"></th>
                                            <td>22</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	12.营业利润<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop23') }"></th>
                                            <td>23</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	13.利润总额<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop24') }"></th>
                                            <td>24</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	14.应付工资（本年累计发生额）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop25') }"></th>
                                            <td>25</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	15.应付福利费（本年累计发生额）<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop26') }"></th>
                                            <td>26</td>
                                            <td>万元</td>
                                        ...
                                        <tr>
                                            <th>&nbsp;&nbsp;&nbsp;&nbsp; 
                                            	16.劳动、失业保险费<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'prop27') }"></th>
                                            <td>27</td>
                                            <td>万元</td>
