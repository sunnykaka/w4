						...
						<script type="text/javascript">
							$(function() {
								...
								checksumer.checksum([
									...
									{id:"prop_serviceRevenue",text:"体育中介服务收入合计"}
									]
								);
								checksumer.checksum([
									{id:"prop_employeeNum",text:"公司年平均从业人员"}, 
									{id:"prop_sportsEmployeeNum",text:"体育中介服务从业人员"}
									]
								);
							});
						</script>
		                    ...
		                    <td style="padding:inherit;" colspan="2">
		                        <table class="thL">
		                            <tbody>
		                                ...
		                                <tr>
		                                    <th>&nbsp;&nbsp;&nbsp;&nbsp;其中：体育中介服务收入合计（万元）：
		                                    	<img class="info" width="12px" height="12px" src="${ctxPath }/ico/info.png" title="${w4:getTip(document, 'serviceRevenue') }"/>
		                                    </th>
		                                    <td><input type="text" name="prop_serviceRevenue" id="prop_serviceRevenue" value="${w4:showNumber(document, 'serviceRevenue')}" data-validation-engine="validate[required,custom[number]]" money="true"/></td>
		                                </tr>
		                                <tr>
