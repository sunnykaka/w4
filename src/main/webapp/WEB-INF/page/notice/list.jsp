    ...
    <div class="box w960 marginLRAuto">
        ...
        <div class="contant w960">
            <ul class=" publick_bgx crumbs">
                <li><b>当前位置：</b></li>
                <li><a href="#"><c:out value="${noticeType.title }" /></a></li>
            </ul>
            <div class="c_con">
            	<ul class="list">
					<c:forEach items="${notices }" var="notice">
                      	<li>
                      		<a href="${ctxPath }/notice/detail.action?noticeId=${notice.id}" title="${notice.title }"><c:out value="${notice.title }" /><span><fmt:formatDate value="${notice.addTime }" pattern="yyyy/MM/dd" /></span></a>
                      	</li>
                  	</c:forEach>            		
            	</ul>
            </div>
